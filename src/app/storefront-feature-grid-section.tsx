  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h3 className="max-w-[14rem] text-[2rem] font-black leading-tight tracking-tight">
          {title}
        </h3>
    ...
    <section className="mx-auto w-full max-w-[112rem] px-4 pb-16 sm:px-6 lg:px-8 2xl:px-10">
      <div className="space-y-8">
        {featureRows.map((row) => (
          <div
            key={row.title}
            className="grid gap-0 overflow-hidden rounded-[1.9rem] border border-slate-200 bg-white xl:grid-cols-[420px_1fr]"
          >
